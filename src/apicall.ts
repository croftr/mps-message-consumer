...
import { DivisionResposne, Division, MemberVoting, CategoryTypes, DivisionDetails } from './models/divisions';
...
export const getDivisionDetails = async (divisionId: number): Promise<DivisionDetails> => {
  ...
  const divisionDetails: DivisionDetails = {
    division,
    ayes: divisionResposne.Ayes,
    noes: divisionResposne.Noes,
  }
